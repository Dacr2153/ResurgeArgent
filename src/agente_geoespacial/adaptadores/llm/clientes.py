...
Cada cliente envuelve un SDK concreto (Anthropic u OpenAI-compatible) y expone
un único método ``completar(system, user) -> str``. Los imports se hacen de forma
perezosa para no forzar ambas dependencias cuando solo se usa una.
"""
