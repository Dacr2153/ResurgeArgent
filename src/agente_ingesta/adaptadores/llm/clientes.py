...
Réplica deliberada del patrón de ``agente_matching/adaptadores/llm/clientes.py``:
cada agente es independiente y no importa del otro, pero la forma se mantiene
idéntica para que el sistema completo sea consistente. Imports perezosos para
no forzar ambas dependencias (anthropic/openai) cuando solo se usa una.
"""
