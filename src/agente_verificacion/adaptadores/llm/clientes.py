...
Copia deliberada del mismo adaptador de `agente_matching`: cada agente es
dueño de su propia capa de infraestructura para no acoplarse entre ramas
paralelas, aunque el patrón (y las dependencias, ya declaradas en
`pyproject.toml`) sea el mismo. Import perezoso para no forzar ambos SDKs.
"""
